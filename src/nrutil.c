...
float **matrix(long nrl, long nrh,
               long ncl, long nch) {
...
float ***f3tensor(long nrl, long nrh,
                  long ncl, long nch,
                  long ndl, long ndh) {
...
int ***i3tensor(long nrl, long nrh,
                long ncl, long nch,
                long ndl, long ndh) {
...
double ***d3tensor(long nrl, long nrh,
                   long ncl, long nch,
                   long ndl, long ndh) {
/* allocate a float 3tensor with range t[nrl..nrh][ncl..nch][ndl..ndh] */
    long i,j,nrow=nrh-nrl+1,ncol=nch-ncl+1,ndep=ndh-ndl+1;
